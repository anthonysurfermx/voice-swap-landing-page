...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    helpText: "You can search markets, analyze whales, and trade prediction markets. Try typing what you want to trade!",
  ...
  es: {
    ...
    onboardCategories: "Que quieres predecir?",
  ...
  pt: {
    ...
    onboardCategories: "O que voce quer prever?",
  ...
  return (
    <div className="mt-2 border border-emerald-500/20 bg-emerald-500/[0.05] px-4 py-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-[11px] font-bold font-mono text-emerald-500 tracking-[1px]">TRADE CONFIRMED</span>
